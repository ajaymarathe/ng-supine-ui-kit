...
```
// Install through NPM
$ npm i ng-supine-design-system --save

OR
//Clone the repo.

$ git clone https://github.com/ajaymarathe/ng-supine-ui-kit.git
```
...
Ng Supine Design System is Angular 6 and Bootstrap 4.x ( bootcatch-themes ) based UI-KIT. It is a component-based design system, It has different color styles and ready to use bootstrap components on a single click.
...
* [Preview](http://preview.bootcatch.com/ng-supine-design-system)
